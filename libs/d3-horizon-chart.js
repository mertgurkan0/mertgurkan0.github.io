...
function horizonChart () {
    ...
    var colors = ['#4575b4', '#74add1', '#abd9e9', '#e0f3f8', '#fee090', '#fdae61', '#f46d43', '#d73027'],
        ...
        x = d3.scaleLinear().domain(["july", "aug", "sep", "oct", "nov", "dec", "jan", "fab", "march", "april", "may", "june"])
            .range([0, width]), // TODO: use ordinal scale instead?
        //x = null,
    ...
    function horizonChart(data) {
        ...
        axis = d3Axis.axisTop(x).ticks(12);
